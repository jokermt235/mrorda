...
#ifndef BOOK_VIEWER_SWIFT_H
#define BOOK_VIEWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="book_viewer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11book_viewer11AppDelegate")
...
SWIFT_CLASS("_TtC11book_viewer17MainFlutterWindow")
