...
#ifndef GO_ROUTER_PAGES_SWIFT_H
#define GO_ROUTER_PAGES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="go_router_pages",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15go_router_pages11AppDelegate")
...
SWIFT_CLASS("_TtC15go_router_pages17MainFlutterWindow")
